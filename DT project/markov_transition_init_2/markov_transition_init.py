...
# =====================================
df = pd.read_csv("/Users/likangwei/Desktop/DT project/initial_regime_2/regime_posteriors_gmm3_adjusted.csv", parse_dates=["date"])
...
# =====================================
lambda_ = 0.7   # keep 70% of empirical matrix, add 30% persistence
I = np.eye(K)
